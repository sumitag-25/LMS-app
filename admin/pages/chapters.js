        ...
        <div class="grid gap-4 animate__animated animate__zoomIn">
            <div class="grid">
                <div class="table-responsive md:col-span-2 p-4 bg-white shadow-sm">
                    <div class="grid md:grid-cols-10 gap-4 justify-between items-center border-b pt-2 pb-4">
                        <h5 class="text-xl font-semibold text-nowrap">Chapters List</h5>
                        ...
                        <div class="text-right">
                            <button data-bs-toggle="modal" data-bs-target="#chapter-modal" class="add-chapter-btn btn bg-red-400 text-white rounded-full">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="chapter-form">
                        <div class="row mb-3">
                            <div class="col-6">
                                <div class="form-group">
                                    <select class="form-select chapter-category" name="category" id="">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <select class="form-select chapter-course" name="course" id="">
                        ...
                        <div class="row mb-3">
                            <div class="form-group">
                                <select class="form-select chapter-topic" name="topic" id="">
                                    <option value="choose course" hidden>Choose topic</option>
                                </select>
                            </div>
                        </div>

                        <div class="row mb-3">
                            <input type="text" name="name" placeholder="Chapter name" class="form-control">
                        </div>

                        <div class="row mb-3">
                            <input type="url" name="notes" placeholder="Notes url" class="form-control">
                        </div>
